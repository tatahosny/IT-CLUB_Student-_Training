...
const NAV_ITEMS = {
  ...
  oc: [
    { path: '/oc', label: 'Scanner', icon: Camera, exact: true },
  ],
}
...
export default function AdminLayout() {
  ...
  const navItems = baseItems.filter(item => {
    ...
    if (role === 'super_admin') return true // Super admin always sees all items in their list
    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: 'var(--color-bg-primary)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <header style={{
          ...
          {/* Left: mobile & PC toggle menu btn */}
