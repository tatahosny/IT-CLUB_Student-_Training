              ...
              >
                ...
                <div style={{ marginTop: 12, borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: 12 }}>
                  {(() => {
                    ...
                    const ocList = staff.filter(u => {
                      const r = getRole(u).toLowerCase();
                      return r === 'oc' || r.includes('organizing') || u.role?.role_name === 'oc';
                    });
                    ...
                    return (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        ...
                        {ocList.length > 0 && (
                          <div style={{ fontSize: 11 }}>
                            <span style={{ color: 'var(--color-cyan)', fontWeight: 800 }}>OC: </span>
                            <span style={{ color: 'var(--color-text-primary)' }}>{ocList.map(u => u.full_name.split(' ')[0]).join(', ')}</span>
                          </div>
                        )}
                      </div>
                    )
