...
export default function OCDashboard() {
  ...
  const startScanner = () => {
    ...
    setTimeout(() => {
      scannerRef.current = new Html5QrcodeScanner('oc-qr-scanner', { fps: 10, qrbox: { width: 250, height: 250 } }, false)
  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}><h1 style={{ fontSize: 26, fontWeight: 800 }}><span className="gradient-text-cyan">OC Scanner Panel</span></h1><p style={{ color: 'var(--color-text-muted)', fontSize: 14, marginTop: 4 }}>Scan student QR codes for attendance</p></div>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, maxWidth: 900 }}>
        <div className="glass-card" style={{ padding: 28 }}>
          ...
          {scanning && <div style={{ marginTop: 16 }}><div id="oc-qr-scanner" style={{ width: '100%' }} /></div>}
        </div>
        <div className="glass-card" style={{ padding: 28 }}>
