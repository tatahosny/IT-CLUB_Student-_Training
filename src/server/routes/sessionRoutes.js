...
router.post('/:id/attendance/open', roleMiddleware('super_admin', 'instructor', 'hr'), openAttendanceWindow);
router.post('/:id/attendance/close', roleMiddleware('super_admin', 'instructor', 'hr'), closeAttendanceWindow);
